...
import { getPostsApi } from '@/src/api/home/getPostsApi'
        ...
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                <Image
                    ...
                    source={require('@/resources/assets/forA.png')}
                />
                <View style={styles.Flex}>
                    ...
                    >
                        <Image
                            ...
                            source={require('@/resources/assets/search.png')}
                        />
                    </TouchableOpacity>
                    <TouchableOpacity
                        onPress={() => {
                    ...
                    >
                        <Image
                            style={styles.IconImage}
                            source={require('@/resources/assets/bell.png')}
                        />
                    </TouchableOpacity>
                </View>
            </View>
                ...
                <View style={styles.ranking}>
                    ...
                    >
                        <Image
                            ...
                            source={require('@/resources/assets/refresh.png')}
                        />
                    </TouchableOpacity>
                </View>
            ...
            <FloatingButton
                ...
                source={require('@/resources/assets/fab.png')}
