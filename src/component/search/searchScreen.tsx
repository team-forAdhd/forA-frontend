...
import { searchStoreContext } from '@/src/state/searchState'
            ...
            <View style={styles.header}>
                <View style={styles.searchBar}>
                    <Image
                        ...
                        source={require('@/resources/assets/greenSearch.png')}
                    />
                    <TouchableOpacity>
                        <TextInput
                    ...
                    >
                        <Image
                            style={styles.IconImage}
                            source={require('@/resources/assets/cancel.png')}
                        />
                    </TouchableOpacity>
                </View>
                <TouchableOpacity
                                    ...
                                    {store.recentSearchTerm.map(
                                        (search, index) => (
                                            ...
                                            >
                                                ...
                                                >
                                                    <Image
                                                        source={require('@/resources/assets/searchHistory_cancel.png')}
                                                        style={
