...
import { ArrowIcon, TitleTextIcon } from '@/resources/assets/SvgComponents'
...
export default function LoginScreen() {
    ...
    const handleLogin = async () => {
        try {
            ...
            if (response.success) {
                userStore.login(response.userId, response.nickname)
                loginFinished()
            } else {
                setLoginFailed(true)
                setEmail('')
        ...
        <View style={styles.container}>
            ...
            <View style={styles.social}>
                ...
                <View style={styles.iconRow}>
                    ...
                    >
                        <Image
                            source={require('@/resources/assets/sns-kakao.png')}
                            style={styles.icon}
                        />
                    </TouchableOpacity>
                    <TouchableOpacity
                    ...
                    >
                        <Image
                            source={require('@/resources/assets/sns-naver.png')}
                            style={styles.icon}
                        />
                    </TouchableOpacity>
                    <TouchableOpacity
                    ...
                    >
                        <Image
                            source={require('@/resources/assets/sns-facebook.png')}
                            style={styles.icon}
                        />
                    </TouchableOpacity>
                    <TouchableOpacity
                    ...
                    >
                        <Image
                            source={require('@/resources/assets/sns-apple.png')}
                            style={styles.icon}
                        />
                    </TouchableOpacity>
