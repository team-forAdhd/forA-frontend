...
import { checkExistingMemberApi } from '@/src/api/join/checkExistingMemberApi'
import { sendAuthApi } from '@/src/api/join/sendAuthApi'
        ...
        <View style={styles.container}>
            ...
            <View style={styles.contents}>
                <View style={styles.inputContainer}>
                    <Text style={text.inputTitleText}>{t('join-name')}</Text>
                    <TextInput
                        style={[
                            text.inputText,
                    ...
                    {nameChecked && (
                        <Image
                            source={require('@/resources/assets/check-icon.png')}
                            style={styles.icon}
                        />
                    )}
                    <View
