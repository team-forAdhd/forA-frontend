                        ...
                        <Image
                            source={
                                selectedImages.includes('join-last-1')
                                    ? require('@/resources/assets/join-last/join-last-1-1.png')
                                    : require('@/resources/assets/join-last/join-last-1.png')
                            }
                        ...
                        <Image
                            source={
                                selectedImages.includes('join-last-2')
                                    ? require('@/resources/assets/join-last/join-last-2-1.png')
                                    : require('@/resources/assets/join-last/join-last-2.png')
                            }
                            style={styles.surveyButton}
                        />
                    </TouchableOpacity>
                        ...
                        <Image
                            source={
                                selectedImages.includes('join-last-3')
                                    ? require('@/resources/assets/join-last/join-last-3-1.png')
                                    : require('@/resources/assets/join-last/join-last-3.png')
                            }
                            style={styles.surveyButton}
                        />
                    </TouchableOpacity>
